...
export class ProcessesApiRequestFactory extends BaseAPIRequestFactory {
  ...
  public async _delete(
    ...
    // Path Params
    const localVarPath = "/jobs/{jobId}".replace(
      "{" + "jobId" + "}",
   ...
   */
  public async executeHabitatDistance(
    ...
    if (
      habitatDistanceProcessParams === null ||
      habitatDistanceProcessParams === undefined
    ) {
   ...
   */
  public async executeImpactMetrics(
    impactMetricsProcessParams: ImpactMetricsProcessParams,
    _options?: Configuration,
  ): Promise<RequestContext> {
    let _config = _options || this.configuration;

    // verify required parameter 'impactMetricsProcessParams' is not null or undefined
    if (
      impactMetricsProcessParams === null ||
      impactMetricsProcessParams === undefined
    ) {
      throw new RequiredError(
        "ProcessesApi",
  ...
  public async execution(
    ...
    // Path Params
    const localVarPath = "/processes/{processID}/execution".replace(
      "{" + "processID" + "}",
  ...
  public async process(
    ...
    // Path Params
    const localVarPath = "/processes/{processID}".replace(
      "{" + "processID" + "}",
      encodeURIComponent(String(processID)),
    );
  ...
  public async results(
    ...
    // Path Params
    const localVarPath = "/jobs/{jobId}/results".replace(
      "{" + "jobId" + "}",
      encodeURIComponent(String(jobId)),
    );
...
export class ProcessesApiResponseProcessor {
   ...
   */
  public async _deleteWithHttpInfo(
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async executeHabitatDistanceWithHttpInfo(
    response: ResponseContext,
   ...
   * to the expected objects
   *
   * @params response Response returned by the server for a request to executeImpactMetrics
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async executeImpactMetricsWithHttpInfo(
    response: ResponseContext,
    ...
    if (isCodeInRange("200", response.httpStatusCode)) {
      const body: BiodiversitySensitiveAreasProcessOutputs =
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async executeNdviWithHttpInfo(
    response: ResponseContext,
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async executionWithHttpInfo(
    response: ResponseContext,
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async processWithHttpInfo(
    response: ResponseContext,
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async processesWithHttpInfo(
    response: ResponseContext,
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async resultsWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<Results>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
   ...
   * @throws ApiException if the response code was not in [200, 299]
   */
  public async statusWithHttpInfo(
    response: ResponseContext,
  ): Promise<HttpInfo<StatusInfo>> {
    const contentType = ObjectSerializer.normalizeMediaType(
      response.headers["content-type"],
