...
export class ObservableProcessesApi {
  ...
  public executeImpactMetricsWithHttpInfo(
    ...
    const requestContextPromise = this.requestFactory.executeImpactMetrics(
    ...
    return middlewarePreObservable
      ...
      .pipe(
        mergeMap((response: ResponseContext) => {
          ...
          return middlewarePostObservable.pipe(
            map((rsp: ResponseContext) =>
              this.responseProcessor.executeImpactMetricsWithHttpInfo(rsp),
            ),
          );
        }),
      );
  ...
  public executeImpactMetrics(
    ...
    return this.executeImpactMetricsWithHttpInfo(
      impactMetricsProcessParams,
      _options,
    ).pipe(
      map(
